...
class TwitterClient: BDBOAuth1SessionManager {
    static let sharedInstance = TwitterClient(baseURL: NSURL(string: "https://api.twitter.com"), consumerKey: "WLpy5cUOSVMMJaoaUJlOzNuwz", consumerSecret: "XnuTDoDJV9t4ICwXAIEAN8QzAGkfzltFRcd9NRGM1dKinB8f1b")
